          ...
          <div class="col-lg-2"  >
			...
			<div class="sidebar">
				<a href="index.php">
					...
					<a href="#contact">Other Products</a>
...
<div class="ref">
        <button type="button" class="btn btn-warning btn-lg"><a href="RAM.php"> NEXT</a></button>
</div>
<?php
if(!empty($_SESSION["shopping_cart"])) {
...
$result = mysqli_query($con,"SELECT * FROM `item`WHERE `item_type` = 'GPU'");
