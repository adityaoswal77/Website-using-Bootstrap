...
$result = mysqli_query($con,"SELECT * FROM `item`WHERE `item_type` = 'ram'");
...
<div class="ref">
        <button type="button" class="btn btn-danger btn-sm"><a href="checkout.php"> NEXT</a></button>
      </div>
