	...
	?>
		<div class='product_wrapper'> 
			  ...
			  <input type='hidden' name='code' value=".$row['code']." />
			   <div class='image' style="width:200px; height : 200px ; padding-top :50px" >
			   <img style="width:100px; height : 100px ; align: center"  src="./product-images/<?php echo $row["image"] ?>" /></div>
